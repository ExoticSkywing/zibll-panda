...
class Hong8438a8ea52daAdminTheme {
	const COLOR_SCHEME_ID = 'Hong8438a8ea52da-color-scheme';
	const MAIN_STYLESHEET_HANDLE = 'Hong8438a8ea52da-admin-theme';
	...
	public function enqueueAdminTheme() {
		...
		wp_enqueue_style(
			...
			$static_panda_url . '/assets/others/admin/style_4/custom-admin-theme.css',
			[],
			panda_version()
		);
	}
...
new Hong8438a8ea52daAdminTheme();