...
/**
 * Plugin Name: lv
 * Description: 自定义管理主题 使用 Admin Menu Editor Pro 插件生成.
 * Version: 1.0
 * Requires PHP: 5.6.20
...
class Lv1046c7db022819AdminTheme {
	const COLOR_SCHEME_ID = 'Lv1046c7db022819-color-scheme';
	const MAIN_STYLESHEET_HANDLE = 'Lv1046c7db022819-admin-theme';
	...
	public function enqueueAdminTheme() {
		...
		wp_enqueue_style(
			...
			$static_panda_url . '/assets/others/admin/style_2/custom-admin-theme.css',
			[],
			panda_version()
		);
	}
...
new Lv1046c7db022819AdminTheme();