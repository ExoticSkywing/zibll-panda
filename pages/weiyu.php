                    ...
                    <main id="main" class="site-main" role="main">
                        <div id="shuoshuo_content">
                            <ul class="cbp_tmtimeline">
                                ...
                                <li><?php echo zib_get_avatar_box($user_id=1, 'shuoshuo_author_img', true, false); ?>
