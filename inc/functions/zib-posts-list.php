...
function zib_get_posts_thumb_graphic($class = 'item-thumbnail')
{
    ...
    if (get_post_meta($post->ID, 'mh_text', true)){
        ...
        $bottom_text = get_post_meta($post->ID, 'bottom_text', true);
        ...
        if ($left_text) {
            if($left_color == 'jb-purple'){
                $sticky = '<badge class="jiaobiao2 bg-color-purple">'.$left_text.'</badge>';
            }else if($left_color == 'jb-red'){
                $sticky = '<badge class="jiaobiao2 bg-color-red">'.$left_text.'</badge>';
            }else if($left_color == 'jb-green'){
                $sticky = '<badge class="jiaobiao2 bg-color-green">'.$left_text.'</badge>';
            }else if($left_color == 'jb-yellow'){
                $sticky = '<badge class="jiaobiao2 bg-color-yellow">'.$left_text.'</badge>';
            }else{
                $sticky = '<badge class="jiaobiao2 '.$left_color.'">'.$left_text.'</badge>';
            }
        } else {
            $sticky = '';
        }
        if ($right_text){
            if($right_color == 'jb-purple'){
                $sticky .= '<a class="item-category bg-color-purple"> '.$right_text.' </a>';
            }else if($right_color == 'jb-red'){
                $sticky .= '<a class="item-category bg-color-red"> '.$right_text.' </a>';
            }else if($right_color == 'jb-green'){
                $sticky .= '<a class="item-category bg-color-green"> '.$right_text.' </a>';
            }else if($right_color == 'jb-yellow'){
                $sticky .= '<a class="item-category bg-color-yellow"> '.$right_text.' </a>';
            }else{
                $sticky .= '<a class="item-category '.$right_color.'"> '.$right_text.' </a>';
            }
            
        }
        if ($bottom_text){
            if($bottom_color == 'jb-purple'){
                $sticky .= '<div class="n-collect-item-bottom bg-color-purple"><span class="bottom-l">'.$bottom_text.'</span></div>';
            }else if($bottom_color == 'jb-red'){
                $sticky .= '<div class="n-collect-item-bottom bg-color-red"><span class="bottom-l">'.$bottom_text.'</span></div>';
            }else if($bottom_color == 'jb-green'){
                $sticky .= '<div class="n-collect-item-bottom bg-color-green"><span class="bottom-l">'.$bottom_text.'</span></div>';
            }else if($bottom_color == 'jb-yellow'){
                $sticky .= '<div class="n-collect-item-bottom bg-color-yellow"><span class="bottom-l">'.$bottom_text.'</span></div>';
            }else{
                $sticky .= '<div class="n-collect-item-bottom '.$bottom_color.'"><span class="bottom-l">'.$bottom_text.'</span></div>';
            }
        }
    }
    if (get_post_meta($post->ID, 'jx', true)){
        $jx_sort = get_post_meta($post->ID, 'jx_sort', true);
        $sticky .= '<badge class="img-badge right jb-red"><svg class="icon" aria-hidden="true"><use xlink:href="#icon-hot"></use></svg>'.$jx_sort.'</badge>';
    }
    ##子主题修改##
