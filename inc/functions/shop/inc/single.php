...
';
    ...
    <div class="flex jsb ac">
        <div class="but-group shop-paybtn-group">
            ...
            <template v-else>
                <!-- V5 布局: [加购] [VIP导流] [原价购(灰)] -->
                <button class="but c-yellow shop-add-cart-btn" @click.prevent="cartBtnClick" ref="addCartBtn">加入购物车</button>
                <a href="https://xingxy.manyuzo.com/会员介绍" target="_blank" class="but xingxy-vip-group-btn">
                   <i class="fa fa-diamond mr3"></i>星冕会员享半价
                </a>
                <button class="but jb-red shop-buy-btn xingxy-vip-secondary-btn" @click.prevent="orderBtnClick">原价购买</button>
            </template>
        </div>
